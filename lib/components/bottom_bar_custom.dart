        ...
        children: [
          Container(
            ...
            child: Row(
              ...
              children: [
                BottomBarButton(
                    widget.currentHomeScreen, 0, Icons.menu, widget.updatePage),
                BottomBarButton(widget.currentHomeScreen, 1,
                    Icons.history_rounded, widget.updatePage),
                const SizedBox(
                  width: 50,
                ),
                BottomBarButton(widget.currentHomeScreen, 3,
                    CupertinoIcons.cart_fill, widget.updatePage),
        ...
        child: Container(
          ...
          child: Icon(
            ...
            color: (currentHomeScreen == 2)
                ? const Color.fromARGB(255, 149, 188, 255)
                : Colors.white,
          ).p(8),
        ),
      ),
