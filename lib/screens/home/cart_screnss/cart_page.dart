      ...
      _rewardedAd!.fullScreenContentCallback = FullScreenContentCallback(
        ...
        onAdDismissedFullScreenContent: (RewardedAd ad) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(
              content: Text("تم طلب الطلب بنجاح"),
                  ...
                  child: Column(
                    children: [
                      ...
                      (city == "الشهداء" ||
                              city == "سرسنا" ||
                              city == "ميت شهاله")
                          ? const Text(" التوصيل مجاني لأي اوردر اكتر من ٥٠",
                              style: TextStyle(fontSize: 18))
                          : const Text(
                              "اطلب اوردر بأكثر من ١٠٠ جنيه للتمتع بسعر دليفري اقل",
                              style: TextStyle(fontSize: 18)),
                    ],
                  ),
                ),
